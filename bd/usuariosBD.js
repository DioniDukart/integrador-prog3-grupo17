...
export default class UsuariosBD {
    crear = async (usuarioNuevo) => {
        ...
        //return infoCreacion;
        if (infoCreacion.affectedRows === 0) {
            return false;
        }
    ...
    buscarTodos= async (filter = null, limit = 0, offset = 0, order = "apellido", asc = "ASC") => {

        // Defino el string de consulta
        let strSql= `SELECT idUsuario, CONCAT(nombre, ' ', apellido) AS usuario, correoElectronico, FROM usuarios WHERE activo=1`;
